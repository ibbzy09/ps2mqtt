# Taken from https://stackoverflow.com/questions/54866488/screen-wake-up-settings-in-power-options-or-registry-for-windows-os 
# Akhilesh you handsome handsome man
